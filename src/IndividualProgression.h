...
{
    IPP_MAP_BLACKWING_LAIR = 469,
    IPP_MAP_ZUL_GURUB = 309,
    IPP_MAP_AQ_20 = 509,
    IPP_MAP_AQ_40 = 531,
    IPP_MAP_OUTLANDS = 530,
    IPP_MAP_NAXXRAMAS = 533,
    IPP_MAP_ZUL_AMAN = 568,
    IPP_MAP_NORTHREND = 571,
    IPP_MAP_ULDUAR = 603,
    IPP_MAP_TRIAL_OF_THE_CRUSADER = 649,
    IPP_MAP_TRIAL_OF_THE_CHAMPION = 650,
    IPP_MAP_ICC = 631,
    IPP_MAP_FORGE_OF_SOULS = 632,
    IPP_MAP_RUBY_SANCTUM = 724
};
